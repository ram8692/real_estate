                                ...
                                <div class="card-tools">
                                    <form action="{{ route('property.list') }}" method="get">
                                        <div class="input-group input-group-sm" style="width: 500px;">
                                            <input type="text " name="city" class="form-control float-right"
                                                placeholder="Search City" value="{{ request('city') }}">
                                            <input type="text" name="nofbrooms" class="form-control float-right"
                                                placeholder="Search No of Bebrooms" value="{{ request('nofbrooms') }}">
                                            <input type="text" name="noffloor" class="form-control float-right"
                                                placeholder="Search No of Floor" value="{{ request('noffloor') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td><a
                                                    ...
                                                    <form id="delete-form-{{ $property->id }}"
                                                        action="{{ route('property.destroy', ['id' => $property->id]) }}"
